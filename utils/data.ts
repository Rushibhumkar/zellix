...
export const allLeadsFilterStatuses = [
  { _id: "followUp_required", name: "Follow Up Required" },
  { _id: "not_interested", name: "Not Interested" },
  { _id: "not_able_to_connect", name: "Not Able to Connect" },
  { _id: "no_response", name: "No Response" },
...
export const reportDummyData = [
  ...
  {
    leadId: "LD-1010",
    clientName: "Sakshi Jain",
    mobile: "9876501234",
    project: "Shapoorji Vanaha",
    source: "Housing",
    assignedTo: "Rohan",
    team: "Pre Sales",
    status: "Warm",
  ...
  {
    leadId: "LD-1014",
    clientName: "Pallavi Joshi",
    mobile: "9444444444",
    project: "Godrej River Royale",
    source: "Reference",
    assignedTo: "Deepak",
    team: "Pre Sales",
    status: "Hot",
  ...
  {
    leadId: "LD-1017",
    clientName: "Ritesh More",
    mobile: "9777777777",
    project: "Godrej Forest Grove",
    source: "Facebook",
    assignedTo: "Kunal",
    team: "Closing Team",
    status: "Cold",
  ...
  {
    leadId: "LD-1019",
    clientName: "Harsh Agrawal",
    mobile: "9999999999",
    project: "Shapoorji Sensorium",
    source: "MagicBricks",
    assignedTo: "Priya",
    team: "Sales Team C",
    status: "Hot",
  ...
  {
    leadId: "LD-1020",
    clientName: "Tanvi Patwardhan",
    mobile: "9000000000",
    project: "Godrej Meadows",
    source: "Reference",
    assignedTo: "Rahul",
    team: "Pre Sales",
    status: "Warm",
  ...
  ...Array.from({ length: 25 }, (_, index) => ({
    leadId: `LD-${1021 + index}`,
    clientName: `Client ${index + 21}`,
    ...
    source: ["Facebook", "Instagram", "Google Ads", "Reference", "MagicBricks"][
      index % 5
    ],
    assignedTo: ["Amit", "Sneha", "Rohit", "Priya", "Kunal"][index % 5],
    team: [
      "Sales Team A",
      "Sales Team B",
      "Sales Team C",
    ...
    status: ["Hot", "Warm", "Cold"][index % 3],
    followUp: `${10 + (index % 20)} Jun`,
    budget: `${70 + index} L`,
    city: ["Pune", "Mumbai", "Thane", "Bangalore"][index % 4],
    meeting: ["Done", "Pending"][index % 2],
    siteVisit: ["Done", "Pending"][index % 2],
    booking: ["Yes", "No"][index % 2],
    payment: ["Completed", "Pending", "Token Paid", "Partial"][index % 4],
    createdAt: `${1 + (index % 10)} May`,
    updatedAt: `${10 + (index % 10)} May`,
  })),
];
...
export const addManualLeadPositiveStatuses = [
  "deal_booked",
  "active_hot",
  "meeting_done",
  "meeting_scheduled",
...
export const addManualLeadNegativeStatuses = [
  "not_interested",
  "not_interested_buy_later",
  "wrong_details",
  // "deal_cancelled",
...
export const leadNeutralStatuses = [
  "followUp_required",
  "call_back",
  "active_cold",
  "nr_event",
...
export const clientLookingForOptions = [
  {
    _id: "rental",
    name: "Rental",
  },
