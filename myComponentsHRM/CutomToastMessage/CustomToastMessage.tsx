      ...
      <Modal animationType="fade" transparent={true} visible={true}>
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <View>
              <CustomText color="white" fontSize={15}>
...
const DummyPoPUp = () => {
    ...
    return (
      <View>
        <CustomBtn
          title="hight"
          onPress={() =>
            props.spSheet.setHeight(HEIGHT - 100, () =>
        ...
        <FlatList
          ...
          renderItem={() => {
            return (
              <CustomText style={{ marginHorizontal: 20, marginBottom: 20 }}>
                Hi, SekizliPenguen
              </CustomText>
            );
          }}
  ...
  const BodyComponent = () => {
    return (
      ...
      >
        <ActivityIndicator color={color.saffronMango} size={"large"} />
        <CustomText fontSize={18} fontWeight="700" color={color.saffronMango}>
          Please Wait...
        </CustomText>
        <TouchableOpacity onPress={() => popUpConfToast.successMessage("das")}>
  ...
  return (
    <>
      ...
      >
        <CustomText>Open Popup Message</CustomText>
      </TouchableOpacity>
      {/* Toast */}
      <TouchableOpacity
        onPress={() =>
      ...
      >
        <CustomText>Open Top Toast</CustomText>
      </TouchableOpacity>
      {/* popup */}
      <TouchableOpacity
        onPress={() => {
          ...
          popup.show({
            ...
            bodyComponent: (bodyProps) => (
              <View>
                <CustomText>Mustafa Kemal ATATÜRK</CustomText>
                <CustomBtn title="qq" onPress={() => Popup.hide()} />
              </View>
            ),
            confirmText: "Cancels",
            iconEnabled: false,
      ...
      >
        <CustomText>Open SPSheet Message</CustomText>
      </TouchableOpacity>
      {/*  */}
    </>
  );
