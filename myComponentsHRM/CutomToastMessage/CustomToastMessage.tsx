...
const DummyPoPUp = () => {
  ...
  return (
    <>
      ...
      >
        <Text style={{ color: "#000" }}>Open Popup Message</Text>
      </TouchableOpacity>
      {/* Toast */}
      <TouchableOpacity
        onPress={() =>
      ...
      >
        <Text style={{ color: "#000" }}>Open Top Toast</Text>
      </TouchableOpacity>
      {/* popup */}
      <TouchableOpacity
        onPress={() => {
      ...
      >
        <Text style={{ color: "#000" }}>Open Popup Confirm Message</Text>
      </TouchableOpacity>
      {/* SPSheet */}
      <TouchableOpacity
        onPress={() => {
      ...
      >
        <Text style={{ color: "#000" }}>Open SPSheet Message</Text>
      </TouchableOpacity>
      {/*  */}
    </>
  );
