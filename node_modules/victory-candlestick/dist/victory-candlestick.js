...
Candle.propTypes = _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_7__.CommonProps.primitiveProps), {}, {
  candleRatio: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
  candleWidth: prop_types__WEBPACK_IMPORTED_MODULE_8___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_8___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_8___default().func)]),
  close: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
  ...
  high: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
  lineComponent: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().element),
  low: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
  open: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
  rectComponent: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().element),
  wickStrokeWidth: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
  width: (prop_types__WEBPACK_IMPORTED_MODULE_8___default().number),
