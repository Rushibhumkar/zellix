...
//component
const ClientInfoNewForm = ({ params }: any) => {
  const { user } = useSelector(selectUser);
  const nav = useNavigation();
  const formik = useFormik({
    initialValues: {
      clients:
        params?.initialValues?.ownerShipDetails?.length > 0
          ? params?.initialValues?.ownerShipDetails
          : [defaultClient1],
  ...
  const deleteFieldPayOther = (
    keyName: "paymentProofArr" | "otherDocs",
    indexToRemove: number
  ) => {
    const updatedArray = formik.values[keyName].filter(
  ...
  return (
    <View>
      <>
          ...
          {formik?.values?.clients?.map((client, index) => (
            <View key={index}>
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.clientName &&
                  formik.touched.clients?.[index]?.clientName && (
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.clientEmail &&
                  formik.touched.clients?.[index]?.clientEmail && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].clientEmail}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.clientMobile &&
                  formik.touched.clients?.[index]?.clientMobile && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].clientMobile}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.passportNumber &&
                  formik.touched.clients?.[index]?.passportNumber && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].passportNumber}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.dateOfBirth &&
                  formik.touched.clients?.[index]?.dateOfBirth && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].dateOfBirth}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.address &&
                  formik.touched.clients?.[index]?.address && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].address}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.passport &&
                  formik.touched.clients?.[index]?.passport && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].passport}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.passport2 &&
                  formik.touched.clients?.[index]?.passport2 && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].passport2}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.emiratesID &&
                  formik.touched.clients?.[index]?.emiratesID && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].emiratesID}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                <ExpoImagePicker
                  ...
                  onBlur={formik.handleBlur(`clients[${index}].emiratesID`)}
                />
                {formik.errors.clients?.[index]?.emiratesID2 &&
                  formik.touched.clients?.[index]?.emiratesID2 && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].emiratesID2}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.visa &&
                  formik.touched.clients?.[index]?.visa && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].visa}
                    </CustomText>
                  )}
              ...
              <View style={{ marginBottom: 15 }}>
                ...
                />
                {formik.errors.clients?.[index]?.visa2 &&
                  formik.touched.clients?.[index]?.visa2 && (
                    <CustomText style={styles.errorText}>
                      {formik.errors.clients[index].visa2}
                    </CustomText>
                  )}
        ...
        {formik.values?.ownership === "grouped" && (
          <CustomBtn
            title="Add More"
            onPress={addClient}
            containerStyle={{
